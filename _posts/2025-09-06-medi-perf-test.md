...
This test also validates the architecture choice: `sled` for storage + `tantivy` for search is reliable and **fast**. It gives me confidence that `medi` will stay responsive with 10_000 notes, just as it is with 10.
