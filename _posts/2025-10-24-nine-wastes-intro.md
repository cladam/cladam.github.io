...
Many are familiar with the seven wastes of _Lean Software Development_, which offer a useful (great actually) lens for spotting process inefficiencies. However, those principles don’t fully capture the human and cognitive frictions that I see in modern software work.

To see the full picture, we need to broaden the definition. I’ve found it more effective to frame the problem around nine distinct categories. 
This model recognises not only process failures, but also cognitive and cultural ones:
...
This list explicitly includes human-centred wastes such as _Psychological Distress_ and _Extraneous Cognitive Load_. In my experience, these are the factors most often overlooked, and often the most damaging.
