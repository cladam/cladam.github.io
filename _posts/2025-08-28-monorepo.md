...
The `status`, `sync` and `info` commands are also monorepo-aware, giving you a clean, relevant view of your working directory by ignoring other projects when you're at the root.
